...
import 'package:habbit_app/started_screens/things/common/step_detail_row.dart';
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          child: Container(
            ...
            child: Icon(Icons.arrow_back_ios_new, color: TColor.black, size: 20),
          ),
        ),
        actions: [
          InkWell(
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () {},
                    icon: Icon(Icons.play_arrow, color: TColor.white, size: 40),
                  ),
                ],
              ),
              const SizedBox(
